...
export default function Show({ movie }) {
    return (
        ...
        >
            ...
            {/* Video Title */}
            <div className="absolute title-video top-7 left-1/2 transform -translate-x-1/2 max-w-[310px] md:max-w-[620px] text-center">
                <span className="font-medium text-2xl transition-all  drop-shadow-md select-none">
                    {movie.name}
                </span>
            </div>
        </section>
